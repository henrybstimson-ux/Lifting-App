...
function InlineSetLogger(_ref9) {
  ...
  var _useState15 = useState(getRestTime(ex.name)),
...
function ExRow(_ref25) {
  ...
  var rootRef = useCallback(function (el) {
...
function DayPage(_ref27) {
  ...
  var _useState41 = useState((_cached === null || _cached === void 0 ? void 0 : _cached.started) || false),
    _useState42 = _slicedToArray(_useState41, 2),
    started = _useState42[0],
    setStarted = _useState42[1],
    _useState43 = useState((_cached === null || _cached === void 0 ? void 0 : _cached.ended) || false),
  ...
  var _useState47 = useState((_cached === null || _cached === void 0 ? void 0 : _cached.elapsed) || 0),
    _useState48 = _slicedToArray(_useState47, 2),
    elapsed = _useState48[0],
    setElapsed = _useState48[1],
    _useState49 = useState((_cached === null || _cached === void 0 ? void 0 : _cached.finalElapsed) || 0),
    _useState50 = _slicedToArray(_useState49, 2),
    finalElapsed = _useState50[0],
    setFinalElapsed = _useState50[1],
    _useState51 = useState((_cached === null || _cached === void 0 ? void 0 : _cached.startTime) || null),
  ...
  var blocksRef = useRef(null);
  var firstBlockRef = useRef(null);
  var exRefs = useRef({});
  var swipe = useSwipe(useCallback(function () {
...
export default function App() {
  ...
  var saveFlashTimer = useRef(null);
  ...
  var globalSwipe = useSwipe(useCallback(function () {
    var i = allPages.indexOf(page);
    if (i < allPages.length - 1) setPage(allPages[i + 1]);
  }, [page, allPages.join(",")]), useCallback(function () {
    var i = allPages.indexOf(page);
